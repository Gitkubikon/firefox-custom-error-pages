...
function setupAdvancedButton() {
  ...
  var container = document.querySelector(".advanced-panel-container");
  ...
  function setupModalControls(container) {
    ...
    // Close button (CSS pseudo-element click handler)
...
async function revealAdvancedPanelSlowlyAsync() {
  ...
  const container = document.querySelector(".advanced-panel-container");
